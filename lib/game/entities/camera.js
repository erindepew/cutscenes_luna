...
.defines(function(){
        ...
        update: function() {
            ...
            if (ig.input.state('click')){
                ...
                if (ig.input.mouse.x > this.pos.x && ig.input.mouse.x < this.pos.x + click_radius && ig.input.mouse.y > this.pos.y && ig.input.mouse.y < this.pos.y + click_radius && ig.input.mouse.x > 50 && ig.input.mouse.x < 550){
